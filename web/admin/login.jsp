...
<%--					<form  action="${pageContext.request.contextPath}/admin/login" method="post">--%>
					<table border="0px" id="table">
						<tr>
							<td class="td1">用户名：</td>
							<td><input type="text" value="admin" placeholder="Username" class="td2" name="aName"></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							<td class="td1">密码：</td>
							<td><input type="password"  value="000000" placeholder="Password" class="td2" name="aPass"></td>
						</tr>
						<tr>
							<td></td>
